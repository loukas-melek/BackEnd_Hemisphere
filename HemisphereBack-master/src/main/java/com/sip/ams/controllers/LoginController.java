 ...
 * 
 * import com.sip.ams.entities.users.User;
 * 
 * @Controller public class LoginController {
 * 
 * @Autowired private com.sip.ams.implementservice.UserService userService;
 * 
 ...
 * ModelAndView accueil(){ ModelAndView modelAndView = new ModelAndView();
